...
class PokemonsViewState extends ConsumerState<PokemonsView> {
  ...
  void infiniScroll() {
    final curruntPokemons = ref.read(pokemonIdsProvider);
    if (curruntPokemons.length > 400) {
      scrollController.removeListener(infiniScroll);
      return;
    }
  ...
  void initState() {
    super.initState();
    scrollController.addListener(infiniScroll);
  }
