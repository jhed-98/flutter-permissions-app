...
extension PokemonQueryFilter
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> typeEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> typeGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> typeLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> typeBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> typeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> typeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> typeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> typeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension PokemonQuerySortBy on QueryBuilder<Pokemon, Pokemon, QSortBy> {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> sortByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PokemonQuerySortThenBy
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> thenByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }
...
extension PokemonQueryProperty
  ...
  QueryBuilder<Pokemon, String?, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
