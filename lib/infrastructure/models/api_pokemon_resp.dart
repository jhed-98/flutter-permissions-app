...
ApiPokemonResp apiPokemonRespFromJson(String str) => ApiPokemonResp.fromJson(json.decode(str));

String apiPokemonRespToJson(ApiPokemonResp data) => json.encode(data.toJson());

class ApiPokemonResp {
    ...
    factory ApiPokemonResp.fromJson(Map<String, dynamic> json) => ApiPokemonResp(
